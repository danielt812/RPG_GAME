$(document).ready(function() {
  ...
  function main() {
    ...
    for (var i = 0; i < objUnit.name.length; i++) {
      ...
      unitEnergyPoints.text(
        'Energy: ' + objUnit.energy[i] + ' / ' + objUnit.energy[i]
      );
  ...
  function selectPlayer() {
    $('body').one('click', '.units', function() {
      ...
      if (selectedChar === 'Ghost') {
        playMusic('assets/audio/terranBackground.mp3');
        playAudio('assets/audio/ghostSelect.mp3');
        ...
        $('.statBoard3').text(
          'Stimpack: Take self-inflicted damage. Deal bonus damage. Lose 2 energy.'
        );
        $('.statBoard4').text(
          'Explosive Charge: After three charges set, deal massive damage. Lose 1 energy.'
        );
        $('.statBoard5').text(
          'Cloak: Prevent damage this turn. Lose 2 energy.'
        );
        $('.statBoard6').text('Choose an enemy.');
        $('.statBoard7').text('');
      } else if (selectedChar === 'Hydralisk') {
        playMusic('assets/audio/zergBackground.mp3');
        playAudio('assets/audio/hydraliskSelect.mp3');
        $('.statBoard0').text('Character Selected: ' + selectedChar);
        $('.statBoard1').text('Race: ZERG');
        $('.statBoard2').text('Basic Attack: Do base damage. Gain 1 energy.');
        $('.statBoard3').text(
          'Spine Flurry: Does 1-3 times base damage. Double damage received. Lose 2 energy.'
        );
        $('.statBoard4').text(
          'Augmented Carapace: Damage reduced. Damage received reduced. Lose 1 energy.'
        );
        $('.statBoard5').text(
          'Regenerate: Heal for random amount. Deal no damage. Lose 3 energy.'
        );
        $('.statBoard6').text('Choose an enemy.');
        $('.statBoard7').text('');
      } else if (selectedChar === 'Dark Templar') {
        playMusic('assets/audio/protossBackground.mp3');
        playAudio('assets/audio/darkTemplarSelect.mp3');
        $('.statBoard0').text('Character Selected: ' + selectedChar);
        $('.statBoard1').text('Race: PROTOSS');
        $('.statBoard2').text('Basic Attack: Do base damage. Gain 1 energy.');
        $('.statBoard3').text(
          'Shadow Fury: Do random number of attacks with random damage value. Lose 2 energy.'
        );
        $('.statBoard4').text(
          'Void Surge: Increment damage output after each time used. Lose 1 energy.'
        );
        $('.statBoard5').text(
          'Evasion: Take no damage. Deal no damage. Gain 15 life. Lose 3 energy.'
        );
        $('.statBoard6').text('Choose an enemy.');
        $('.statBoard7').text('');
      }
  ...
  function ghostAttacks() {
    $('#ghostBasicAttack').on('click', function() {
      ...
      if (enemySelected === true) {
        playAudio('assets/audio/ghostBasicAttack.mp3');
    ...
    $('#ghostSpecial1').on('click', function() {
      // STIMPACK
      if (enemySelected === true) {
        playAudio('assets/audio/ghostSpecial1.mp3');
        ...
        if (parseInt(playerEnergy) < 2) {
          playAudio('assets/audio/ghostEnergy.mp3');
          ...
          $('.statBoard1').text(
            'You need more energy to perform this ability.'
          );
          ...
          var playerDiv = $('#player').children();
          $(playerDiv[3]).text(
            'Energy: ' + updatePlayerEnergy + ' / ' + playerMaxEnergy
          );
          $(playerDiv[2]).text('HP: ' + dmgTaken + ' / ' + playerMaxHp);
          // ENEMY CHARACTER
          //======================================================================
          ...
          $('.statBoard1').text(
            'Total Damage Received: ' + stimpackDamageTaken
          );
    ...
    $('#ghostSpecial2').on('click', function() {
      // EXPLOSIVE CHARGE
      if (enemySelected === true) {
        playAudio('assets/audio/ghostSpecial2.mp3');
        specialAttackClick++;
        ...
        if (parseInt(playerEnergy) < 1) {
          // Not enough energy audio file here
          playAudio('assets/audio/ghostEnergy.mp3');
          // No Damage for either player
          enemyDmgTaken = enemyHp - 0;
          dmgTaken = playerHp - 0;
          ...
          if (specialAttackClick === 3) {
            ...
            $('.statBoard1').text('Total Damage Received: ' + enemyCharAtk);
            $('.statBoard2').text(
              'Total Damage Dealt: ' + explosiveChargeDamage
            );
            $('.statBoard3').text('Charges: ' + specialAttackClick);
            $('.statBoard4').text(
              'Explosive Charge Damage: ' + explosiveChargeRandNum
            );
    ...
    $('#ghostHeal').on('click', function() {
      // CLOAK
      if (enemySelected === true) {
        playAudio('assets/audio/ghostHeal.mp3');
  ...
  function hydraliskAttacks() {
    $('#hydraliskBasicAttack').on('click', function() {
      // BASIC ATTACK
      if (enemySelected === true) {
        playAudio('assets/audio/hydraliskBasicAttack.mp3');
        // THIS ATTACK ONLY DOES BASE DAMAGE
        //======================================================================
        // YOUR CHARACTER
        // Your character's health point values
    ...
    $('#hydraliskSpecial1').on('click', function() {
      ...
      if (enemySelected === true) {
        ...
        if (parseInt(playerEnergy) < 2) {
          // Not enough energy audio file here
          playAudio('assets/audio/hydraliskEnergy.mp3');
          // No Damage for either player
          enemyDmgTaken = enemyHp - 0;
          dmgTaken = playerHp - 0;
          // Update stat board
          ...
          playAudio('assets/audio/hydraliskSpecial1.mp3');
          // Enemies attack value
          var enemyCharAtk = Math.floor(7 + Math.random() * 13);
          // Subtracting HP from enemy attack value
    ...
    $('#hydraliskSpecial2').on('click', function() {
      ...
      if (enemySelected === true) {
        ...
        if (parseInt(playerEnergy) < 1) {
          ...
          playAudio('assets/audio/hydraliskSpecial2.mp3');
          // Enemies attack value
          var enemyCharAtk = Math.floor(7 + Math.random() * 13);
    ...
    $('#hydraliskHeal').on('click', function() {
      ...
      if (enemySelected === true) {
        ...
        if (parseInt(playerEnergy) < 3) {
          ...
          playAudio('assets/audio/hydraliskHeal.mp3');
          // Enemies attack value
          var enemyCharAtk = Math.floor(7 + Math.random() * 13);
          // Subtracting HP from enemy attack value
          var dmgTaken = playerHp - enemyCharAtk;
  ...
  function darkTemplarAttacks() {
    $('#darkTemplarBasicAttack').on('click', function() {
      if (enemySelected === true) {
        playAudio('assets/audio/darkTemplarBasicAttack.mp3');
        // THIS ATTACK ONLY DOES BASE DAMAGE
        //======================================================================
        // YOUR CHARACTER
        // Your character's health point values
    ...
    $('#darkTemplarSpecial1').on('click', function() {
      ...
      if (enemySelected === true) {
        ...
        if (parseInt(playerEnergy) < 2) {
          // Not enough energy audio file here
          playAudio('assets/audio/darkTemplarEnergy.mp3');
          // No Damage for either player
          enemyDmgTaken = enemyHp - 0;
          dmgTaken = playerHp - 0;
          // Update stat board
          ...
          playAudio('assets/audio/darkTemplarSpecial1.mp3');
          // Enemies attack value
          var enemyCharAtk = Math.floor(7 + Math.random() * 13);
          // Subtracting HP from enemy attack value
          var dmgTaken = playerHp - enemyCharAtk;
    ...
    $('#darkTemplarSpecial2').on('click', function() {
      ...
      if (enemySelected === true) {
        ...
        if (parseInt(playerEnergy) < 1) {
          ...
          playAudio('assets/audio/darkTemplarSpecial2.mp3');
          // Enemies attack value
          var enemyCharAtk = Math.floor(7 + Math.random() * 13);
          // Subtracting HP from enemy attack value
          var dmgTaken = playerHp - enemyCharAtk;
          ...
          $('.statBoard5').text(
            'Incremented Damage: ' + heroCharAtkIncrementStat
          );
    ...
    $('#darkTemplarHeal').on('click', function() {
      ...
      if (enemySelected === true) {
        ...
        if (parseInt(playerEnergy) < 3) {
          ...
          playAudio('assets/audio/darkTemplarHeal.mp3');
  ...
  function checkWinLoss() {
    ...
    if (parseInt(playerHp) <= 0) {
      if (playerName === 'Ghost') {
        playAudio('assets/audio/ghostDeath.mp3');
        playMusic('assets/audio/terranDefeat.mp3');
      } else if (playerName === 'Hydralisk') {
        playAudio('assets/audio/hydraliskDeath.mp3');
        playMusic('assets/audio/zergDefeat.mp3');
      } else if (playerName === 'Dark Templar') {
        playAudio('assets/audio/darkTemplarDeath.mp3');
        playMusic('assets/audio/protossDefeat.mp3');
      }
      var reset = $('<button>');
    ...
    // Win condition
      ...
      if (totalEnemies === 0) {
        if (playerName === 'Ghost') {
          playMusic('assets/audio/terranVictory.mp3');
        } else if (playerName === 'Hydralisk') {
          playMusic('assets/audio/zergVictory.mp3');
        } else if (playerName === 'Dark Templar') {
          playMusic('assets/audio/protossVictory.mp3');
        }
        var reset = $('<button>');
        reset.attr('id', 'resetButton');
        reset.text('YES');
